...
mkdirs -p FORECASTS_DIR/$YMD/inflows
mkdirs -p FORECASTS_DIR/$YMD/namelists
mkdirs -p FORECASTS_DIR/$YMD/outputs
mkdirs -p FORECASTS_DIR/$YMD/logs
mkdirs -p FORECASTS_DIR/$YMD/maptables
